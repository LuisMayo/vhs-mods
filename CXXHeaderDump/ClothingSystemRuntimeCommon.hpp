...
{
    FClothPhysicalMeshData PhysicalMeshData;                                          // 0x0000 (size: 0x110)
    FClothCollisionData CollisionData;                                                // 0x0110 (size: 0x40)
    bool bUseMultipleInfluences;                                                      // 0x0150 (size: 0x1)
    float SkinningKernelRadius;                                                       // 0x0154 (size: 0x4)
...
struct FClothPhysicalMeshData
{
    ...
    TArray<uint32> MorphIndexRemap;                                                   // 0x00B8 (size: 0x10)
    int32 MorphSectionIndex;                                                          // 0x00C8 (size: 0x4)
    TArray<float> MaxDistances;                                                       // 0x00D0 (size: 0x10)
    TArray<float> BackstopDistances;                                                  // 0x00E0 (size: 0x10)
    TArray<float> BackstopRadiuses;                                                   // 0x00F0 (size: 0x10)
    TArray<float> AnimDriveMultipliers;                                               // 0x0100 (size: 0x10)
...
class UClothLODDataCommon_Legacy : public UObject
{
    ...
    FClothPhysicalMeshData ClothPhysicalMeshData;                                     // 0x0030 (size: 0x110)
    FClothCollisionData CollisionData;                                                // 0x0140 (size: 0x40)

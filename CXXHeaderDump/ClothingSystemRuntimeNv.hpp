...
{
    TArray<float> MaxDistances;                                                       // 0x00F8 (size: 0x10)
    TArray<float> BackstopDistances;                                                  // 0x0108 (size: 0x10)
    TArray<float> BackstopRadiuses;                                                   // 0x0118 (size: 0x10)
    TArray<float> AnimDriveMultipliers;                                               // 0x0128 (size: 0x10)

...
enum class EAbilityType_Werewolf {
    AB_Berserk = 0,
    AB_Howl = 1,
    AB_Sense = 2,
    AB_Count = 3,
...
enum class EAbilityUnuseableReason {
    AUR_None = 0,
    AUR_Cooldown = 1,
    AUR_Proximity = 2,
    AUR_NoSelection = 3,
...
enum class EAnalyticsManagerStatus {
    AMS_Disabled = 0,
    AMS_Offline = 1,
    AMS_Enabled = 2,
    AMS_MAX = 3,
...
enum class EBackendExecutionState {
    BES_Idle = 0,
    BES_ExecutingJob = 1,
...
enum class EBackendSimpleOperationState {
    BSOS_Idle = 0,
    BSOS_InProgress = 1,
    BSOS_Succeeded = 2,
    BSOS_Failed = 3,
...
enum class EBarTimingMinigameOutcomeType {
    EBTMOT_NONE = 0,
    EBTMOT_PASS = 1,
    EBTMOT_FAIL = 2,
    EBTMOT_BULLSEYE = 3,
...
enum class EBarTimingMinigameType {
    EBTMT_NONE = 0,
    EBTMT_CRAFTING = 1,
    EBTMT_PRONE = 2,
    EBTMT_COUNT = 3,
...
enum class EBlueprintLightmapType {
    EBLT_Default = 0,
    EBLT_ForceSurface = 1,
...
enum class ECategoryButtonState {
    CBS_None = 0,
    CBS_Normal = 1,
    CBS_Selected = 2,
...
enum class ECharacterDecalType {
    TT_LeftHand = 0,
    TT_RightHand = 1,
    TT_LeftFoot = 2,
    TT_RightFoot = 3,
...
enum class ECharacterSelectStyle {
...
enum class ECharacterStatusOutputMappingType {
    CSO_Curve = 0,
    CSO_FloatRange = 1,
    CSO_ColorRange = 2,
    CSO_Vector = 3,
...
enum class ECharacterStatusSource {
    CSS_Movement = 0,
    CSS_Weapon = 1,
    CSS_State = 2,
    CSS_Evil = 3,
...
enum class ECharacterTypeFilterBits {
    CTFB_FemaleSex = 0,
    CTFB_MaleSex = 1,
...
enum class EChunkReleaseCategory {
    CRC_Mainline = 1,
    CRC_Friends = 2,
    CRC_MAX = 3,
};

enum class EClientMatchmakingType {
    CMM_None = 0,
    CMM_Play = 1,
    CMM_Survive = 2,
    CMM_Kill = 3,
...
enum class EComponentAlignType {
    FACE = 0,
    FACEYAWONLY = 1,
    COPYROTATION = 2,
    FACEYAWONLYQUICK = 3,
...
enum class ECrossPlatformLoginState {
    CPLS_NotLoggedIn = 0,
    CPLS_LoggedIn = 1,
    CPLS_LoggingIn = 2,
    CPLS_FailedLogin = 3,
...
enum class ECustomizationModel {
    CM_None = 0,
    CM_Character = 1,
    CM_Weapon = 2,
    CM_Spectral = 3,
...
enum class ECustomizationPreviewMode {
    CPM_None = 0,
    CPM_Clothing = 1,
    CPM_Emote = 2,
    CPM_EvilScream = 3,
...
enum class EEradicatorHUDState {
    AssaultMode = 0,
    VehicleMode = 1,
    Scan = 2,
    Surge = 3,
...
enum class EEvilPlayerHUDState {
    EPS_Normal = 0,
    EPS_Injured1 = 1,
    EPS_Injured2 = 2,
    EPS_Injured3 = 3,
...
enum class EGameLiftPlayerSessionStatus {
    GLPSS_NotSet = 0,
    GLPSS_Reserved = 1,
    GLPSS_Active = 2,
    GLPSS_Completed = 3,
...
enum class EGameTypeForMatchmaking {
    GTFM_None = 0,
    GTFM_Ranked = 1,
    GTFM_Unranked = 2,
    GT_COUNT = 3,
...
enum class EHUDNotificationType {
    HNT_None = 0,
    HNT_Rage = 1,
    HNT_DarkShard = 2,
    HNT_LifeEssence = 3,
...
enum class EHUDTextureIconsExtended {
    TIE_NONE = 0,
...
enum class EHeatmapAccumulationMethod {
    HAM_RollingAverage = 0,
    HAM_Average = 1,
    HAM_Max = 2,
};

enum class EHeatmapFileLocation {
    HFL_PlaytestPath = 0,
    HFL_CustomPath = 1,
...
enum class EImpactParticles {
    IP_None = 0,
    IP_Flames = 1,
    IP_MAX = 2,
};

enum class EImpactPhysicsBehaviour {
    IPB_None = 0,
    IPB_Launch = 1,
    IPB_Poltergeist = 2,
    IPB_ShieldOrbit = 3,
...
enum class EInputBindingCategory {
    IBC_KbdMain = 0,
    IBC_KbdTeen = 1,
    IBC_KbdEvil = 2,
...
enum class EInteractablePropType {
    IP_None = 0,
    IP_SimulateOnce = 1,
    IP_Wobble = 2,
    IP_Threshold = 3,
...
enum class ELoadingScreenState {
    LS_Inactive = 0,
    LS_Setup = 1,
    LS_FadeIn = 2,
...
enum class ELobbyDisconnectReason {
    LDR_None = 0,
    LDR_Kicked = 1,
...
enum class ELobbyPlayerWidgetMode {
    LPWM_None = 0,
    LPWM_Player = 1,
    LPWM_Open = 2,
    LPWM_COUNT = 3,
...
enum class EMatchEventCategory {
    MEC_MatchStats = 0,
    MEC_Character = 1,
    MEC_CharLevel = 2,
    MEC_CharStarPower = 3,
...
enum class EMatchEventLocTable {
    MELT_DEFAULT = 0,
    MELT_HBCINTERNAL = 1,
...
enum class EMatchmakingNetworkLatencyStatus {
    MNLS_Success = 0,
    MNLS_Timeout = 1,
    MNLS_Unreachable = 2,
    MNLS_Unresolvable = 3,
...
enum class EMatchmakingPingRegion {
    MPR_US_West2 = 0,
    MPR_US_East1 = 1,
    MPR_EU_Central1 = 2,
    MPR_AP_NorthEast2 = 3,
...
enum class EMatchmakingPlayerType {
    MPT_Player = 0,
...
enum class EMeshSlotVisibility {
    MSV_Full = 1,
    MSV_Partial = 2,
    MSV_PartialLeft = 4,
    MSV_PartialRight = 8,
...
enum class EPlayAsForMatchmaking {
    PAFM_None = 0,
    PAFM_Any = 1,
    PAFM_Teen = 2,
    PAFM_Evil = 3,
...
enum class EPlayerAccountDisplayType {
    PADT_None = 0,
    PADT_Time = 1,
    PADT_Count = 2,
    PADT_CountPercent = 3,
...
enum class EPlayerAccountStatType {
    PAST_None = 0,
...
enum class EPlayerEndOfMatchState {
    PS_None = 0,
...
enum class EPlayerHUDActionState {
    PAS_None = 99,
    PAS_BeingChased = 0,
    PAS_Crafting = 1,
    PAS_Healing = 2,
...
enum class EPlayerPresenceState {
    PPS_Launching = 0,
    PPS_FrontEnd = 1,
    PPS_Lobby = 2,
    PPS_Game = 3,
...
enum class EPlotTwist {
    PT_HSBPMap = 0,
    PT_MAX = 1,
};

enum class EPointState {
    VACANT = 0,
    APPROACH = 1,
    INTRO_ANIM = 2,
    USING = 3,
...
enum class ERingAligningMinigameType {
    ERAMT_NONE = 0,
...
enum class ERotatorMinigameType {
    ERMT_NONE = 0,
...
enum class ESearchableEventObjectType {
    NONE = 0,
    HALLOWEEN = 1,
    HOLIDAY = 2,
    EASTER = 3,
...
enum class ESelectionNavigation {
    NAV_NONE = 0,
    NAV_UP = 1,
    NAV_RIGHT = 2,
    NAV_DOWN = 3,
...
enum class EServerConnectionType {
    SCT_None = 0,
    SCT_SinglePlayer = 1,
    SCT_P2PHost = 2,
    SCT_P2PClient = 3,
...
enum class ESmokeTestType {
    TESTTYPE_FPSANDLIGHTING = 0,
    TESTTYPE_KEYBOARDMONKEY = 1,
    TESTTYPE_MAX = 2,
};

enum class ESocialCategoryType {
    SCT_NONE = 0,
    SCT_Lobby = 1,
    SCT_Friends = 2,
    SCT_RecentPlayers = 3,
...
enum class ESocialNotificationAction {
    SNA_None = 0,
    SNA_Accept = 1,
    SNA_Decline = 2,
    SNA_Block = 3,
...
enum class ESocialPlatformType {
    SPT_Epic = 0,
    SPT_Stream = 1,
    SPT_Console = 2,
    SPT_COUNT = 3,
...
enum class ESocialVoiceSliderType {
...
enum class EStatDisplayForGroup {
    ShowSelfOnly = 0,
...
enum class EStatWidgetCombinationType {
    SWTC_Combined = 0,
    SWTC_HighestOnly = 1,
    SWTC_MAX = 2,
};

enum class EStatWidgetType {
    SWT_StatSmall = 0,
    SWT_StatLarge = 1,
    SWT_Trophy = 2,
    SWT_MAX = 3,
...
enum class EStoreCommandGrantableType {
    ESCGT_PrizePack = 0,
...
enum class EStoreRealMoneyStoreType {
    ESRMST_None = 0,
    ESRMST_Steam = 1,
    ESRMST_Epic = 2,
    ESRMST_Count = 3,
...
enum class EStreakRewardTimeFrame {
    ESRTF_Daily = 0,
    ESRTF_Weekly = 1,
    ESRTF_Monthly = 2,
    ESRTF_Count = 3,
...
enum class ETeenWeaponAttackFinishedState {
    Finished = 0,
    OutOfRange = 1,
    Interrupted = 2,
    Blocked = 3,
...
enum class ETipsVisibilityFlags {
    TVG_NONE = 0,
    TVF_NoTips = 1,
    TVF_Basic = 2,
    TVF_Intermediate = 4,
...
enum class EToadArmourEffectState {
    TAS_Inactive = 0,
    TAS_Charging = 1,
    TAS_Active = 2,
    TAS_ExpireQueued = 3,
...
enum class ETriggerCollisionShape {
    TC_Sphere = 0,
    TC_Box = 1,
    TC_Capsule = 2,
    TC_MAX = 3,
...
enum class ETritonSpatializationMode {
    PORTALDIR = 0,
    DIRECTZDIR = 1,
    DIRECTDIR = 2,
    MIXEDDIR = 3,
...
enum class ETuckPointBehaviour {
    TPB_TUCK = 0,
    TPB_OVER = 1,
    TPB_MAX = 2,
};
...
enum class EViewportTickableFlags {
    Editor = 1,
    Game = 2,
    EditorPreview = 4,
    GamePreview = 8,
...
enum class EWerewolfCharacterState {
    NONE = 0,
    SCREAMING = 1,
    FEASTING = 2,
    HOWLING = 3,
...
enum class EWise_AMB_SWITCHGROUP_Music {
...
enum class EWise_CRFT_SWITCHGROUP_Weapon {
    CRFT_W_Cross = 0,
...
enum class EWise_DARKSHARD_SWITCHGROUP_IsEmpowered {
    DARKSHARD_IE_True = 0,
...
enum class EWise_DMG_DamageTypes {
    DMG_DT_Burn = 0,
    DMG_DT_Shock = 1,
    DMG_DT_Holy = 2,
    DMG_DT_Occult = 3,
...
enum class EWise_EVIL_AS_COM_Type {
...
enum class EWise_FEM_SWITCHGROUP_Playlist {
    FEM_P_Launch = 0,
    FEM_P_Menu = 1,
    FEM_P_GoodWon = 2,
    FEM_P_EvilWon = 3,
...
enum class EWise_FOOT_SWITCHGROUP_MovementStyle {
    FOOT_MS_Crawl = 0,
    FOOT_MS_Crouch = 1,
    FOOT_MS_Walk = 2,
    FOOT_MS_Run = 3,
...
enum class EWise_FOOT_SWITCHGROUP_Sole {
    FOOT_S_Sneaker = 0,
    FOOT_S_Werewolf = 1,
    FOOT_S_DollMaster = 2,
...
enum class EWise_HIDE_SWITCHGROUP_Type {
    HIDE_T_Locker = 0,
    HIDE_T_Closet = 1,
    HIDE_T_SIZEOF = 2,
    HIDE_T_MAX = 3,
...
enum class EWise_IMP_ImpactType {
    IMP_IT_HeavyBump = 0,
    IMP_IT_Kick = 1,
    IMP_IT_LightBump = 2,
    IMP_IT_Collision = 3,
...
enum class EWise_IMP_ObjectType {
    IMP_OT_WoodChair = 0,
...
enum class EWise_PICKUP_Adrenaline {
    PICKUP_A_Default = 0,
    PICKUP_A_Holiday = 1,
    PICKUP_A_SIZEOF = 2,
    PICKUP_A_MAX = 3,
...
enum class EWise_PICKUP_Noisemaker {
    PICKUP_N_Default = 0,
    PICKUP_N_Holiday = 1,
    PICKUP_N_SIZEOF = 2,
    PICKUP_N_MAX = 3,
...
enum class EWise_SURF_SWITCHGROUP_ImpactSurfaceType {
    SURF_IST_Concrete = 0,
...
enum class EWise_SURF_SWITCHGROUP_SurfaceType {
    SURF_ST_Sand = 0,
    SURF_ST_Grass = 1,
    SURF_ST_Soil = 2,
    SURF_ST_Gravel = 3,
...
enum class EWise_TEEN_SWITCHGROUP_ElectrocutionCount {
    TEEN_EC_Single = 0,
    TEEN_EC_Multiple = 1,
    TEEN_EC_SIZEOF = 2,
    TEEN_EC_MAX = 3,
...
enum class EWise_TEEN_SWITCHGROUP_GoopedCount {
    TEEN_GC_Multiple = 0,
    TEEN_GC_Single = 1,
    TEEN_GC_SIZEOF = 2,
    TEEN_GC_MAX = 3,
...
enum class EWise_TENS_EvilCharacterType {
    TENS_ECT_Werewolf = 0,
...
enum class EWise_TENS_EvilTension {
    TENS_ET_ET1 = 0,
    TENS_ET_ET2 = 1,
    TENS_ET_ET0 = 2,
    TENS_ET_ET3 = 3,
...
enum class EWise_TENS_MyCharacterType {
    TENS_MCT_Evil = 0,
    TENS_MCT_Teen = 1,
...
enum class EWise_VO_SWITCHGROUP_CharacterType {
    VO_CT_Male = 0,
    VO_CT_Female = 1,
    VO_CT_JOCK = 2,
    VO_CT_PUNK = 3,
...
enum class EWise_VO_SWITCHGROUP_EvilBreathingType {
    VO_EBT_Idle = 0,
    VO_EBT_Active = 1,
    VO_EBT_Vanquished = 2,
    VO_EBT_Sense = 3,
...
enum class EWise_VO_SWITCHGROUP_TeenBreathingType {
    VO_TBT_Idle = 0,
    VO_TBT_Active = 1,
...
enum class EWise_WEP_DemonSword {
    WEP_DS_Default = 0,
    WEP_DS_Bone = 1,
    WEP_DS_Royal = 2,
    WEP_DS_Fantasy = 3,
...
enum class EWise_WEP_FlameMine {
    WEP_FM_Default = 0,
    WEP_FM_SpareParts = 1,
...
enum class EWise_WEP_Flamethrower {
    WEP_F_Default = 0,
    WEP_F_BugSpray = 1,
    WEP_F_ForestAir = 2,
    WEP_F_HairSpray = 3,
...
enum class EWise_WEP_HolySlingshot {
    WEP_HS_Gold = 0,
    WEP_HS_Military = 1,
...
enum class EWise_WEP_HolyStaff {
    WEP_HS_Default = 0,
...
enum class EWise_WEP_Parchment {
    WEP_P_Default = 0,
    WEP_P_Spaghetti = 1,
    WEP_P_Goat = 2,
    WEP_P_Robot = 3,
...
enum class EWise_WEP_StaticShield {
    WEP_SS_Default = 0,
    WEP_SS_Alien = 1,
    WEP_SS_Birthday = 2,
    WEP_SS_Cyber = 3,

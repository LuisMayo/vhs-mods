#ifndef UE4SS_SDK_Walkie_AnimBP_HPP
#define UE4SS_SDK_Walkie_AnimBP_HPP

class UWalkie_AnimBP_C : public UAnimInstance
{
    ...
    class AWalkiePickup* WalkiePickup;                                                // 0x0560 (size: 0x8)

    void AnimGraph(FPoseLink& AnimGraph);
    void BlueprintUpdateAnimation(float DeltaTimeX);
    void BlueprintInitializeAnimation();
    void ExecuteUbergraph_Walkie_AnimBP(int32 EntryPoint);
}; // Size: 0x568

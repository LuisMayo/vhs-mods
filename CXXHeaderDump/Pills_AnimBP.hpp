#ifndef UE4SS_SDK_Pills_AnimBP_HPP
#define UE4SS_SDK_Pills_AnimBP_HPP

class UPills_AnimBP_C : public UAnimInstance
{
    ...
    class APillsPickup* PillsPickup;                                                  // 0x0560 (size: 0x8)

    void AnimGraph(FPoseLink& AnimGraph);
    void BlueprintUpdateAnimation(float DeltaTimeX);
    void BlueprintInitializeAnimation();
    void ExecuteUbergraph_Pills_AnimBP(int32 EntryPoint);
}; // Size: 0x568
